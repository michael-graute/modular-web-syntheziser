...
import type { Connection, SignalType } from '../core/types';
...
export interface ModulationScalingNode {
  ...
  /**
   * Source audio node (LFO's output gain node)
  ...
  /**
   * Source component ID (LFO component ID)
   * Used for tracking which LFO modulates which parameters
   */
  sourceComponentId: string;

  /**
   * Target component ID
   * Used for parameter-to-LFO mapping
   */
  targetComponentId: string;

  /**
   * Target port ID (parameter ID)
   * Used for parameter-to-LFO mapping
   */
  targetPortId: string;
}
