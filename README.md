...
The first version of this project was built in October 2025 by an experienced typescript developer using only AI prompts in [Claude Code](https://claude.ai)/Sonnet 4.5 with the assistance of [GitHub Spec-Kit](https://github.com/github/spec-kit), no code has been written "by hand". Total development time until current state is roughly about 160 hours.
